                        ...
                        <View>
                            {!item.cancel && <View style={styles.card}>
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    <View>
                                        <TouchableOpacity style={styles.btn} onPress={() => Updatedata({ id: item.id, name: item.name, timeValue: item.timeValue, typeValue: item.typeValue, doctor: 'Dr.Doctor', place: 'narsapuram', cancel: true })}>
